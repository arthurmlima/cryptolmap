...
# Path of this script: /home/arthur/crypto/sw/appcpp_system/_ide/scripts/debugger_appcpp-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /home/arthur/crypto/sw/appcpp_system/_ide/scripts/debugger_appcpp-default.tcl
# 
...
fpga -file /home/arthur/crypto/sw/appcpp/_ide/bitstream/cryptolmap.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
dow /home/arthur/crypto/sw/appcpp/Debug/appcpp.elf
