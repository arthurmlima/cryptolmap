...
#define XTOP_MODULE_CONTROL_ADDR_U_DT_DATA   0x10
...
#define XTOP_MODULE_CONTROL_ADDR_M_PERM_DATA 0x20
#define XTOP_MODULE_CONTROL_BITS_M_PERM_DATA 32
#define XTOP_MODULE_CONTROL_ADDR_M_PERM_CTRL 0x24
