...
architecture behav of top_module is 
    ...
    "top_module_top_module,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=11.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.015000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=121,HLS_SYN_DSP=0,HLS_SYN_FF=10223,HLS_SYN_LUT=18083,HLS_VERSION=2022_2}";
