...
entity top_module_fifo_w64_d32768_A is
    generic (
...
architecture arch of top_module_fifo_w64_d32768_A is

    -- component
    component top_module_fifo_w64_d32768_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_top_module_fifo_w64_d32768_A_ram : top_module_fifo_w64_d32768_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity top_module_fifo_w64_d32768_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 64;
        ADDR_WIDTH  : integer := 15;
...
architecture arch of top_module_fifo_w64_d32768_A_ram is
