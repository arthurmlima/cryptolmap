...
reg   [31:0] u_diff_read_reg_593;
wire   [31:0] grp_fu_257_p1;
reg   [31:0] uu_diff_reg_598;
wire    ap_CS_fsm_state4;
wire   [0:0] outHash_last_V_fu_403_p2;
reg   [0:0] outHash_last_V_reg_637;
wire    ap_CS_fsm_state28;
wire   [0:0] icmp_ln92_fu_391_p2;
wire   [31:0] grp_generic_modf_float_s_fu_223_ap_return;
reg   [31:0] x_diff_3_reg_648;
wire    ap_CS_fsm_state50;
wire   [31:0] grp_generic_modf_float_s_fu_230_ap_return;
reg   [31:0] y_diff_reg_653;
wire   [30:0] trunc_ln368_fu_436_p1;
reg   [30:0] trunc_ln368_reg_658;
wire    ap_CS_fsm_state54;
wire   [31:0] map_diff_fu_447_p1;
wire    ap_CS_fsm_state55;
reg   [7:0] xs_exp_V_reg_668;
wire    ap_CS_fsm_state59;
wire   [22:0] p_Result_16_fu_466_p1;
reg   [22:0] p_Result_16_reg_674;
...
wire    grp_generic_modf_float_s_fu_223_ap_done;
...
wire    grp_generic_modf_float_s_fu_223_ap_start;
wire    grp_generic_modf_float_s_fu_223_ap_idle;
wire    grp_generic_modf_float_s_fu_223_ap_ready;
reg   [31:0] grp_generic_modf_float_s_fu_223_x;
wire    grp_generic_modf_float_s_fu_230_ap_start;
wire    grp_generic_modf_float_s_fu_230_ap_done;
wire    grp_generic_modf_float_s_fu_230_ap_idle;
wire    grp_generic_modf_float_s_fu_230_ap_ready;
...
reg    grp_generic_modf_float_s_fu_223_ap_start_reg;
wire    ap_CS_fsm_state27;
reg    grp_generic_modf_float_s_fu_230_ap_start_reg;
reg    grp_generic_remainder_float_s_fu_237_ap_start_reg;
wire    ap_CS_fsm_state58;
reg   [3:0] i_fu_138;
wire   [3:0] i_8_fu_352_p2;
wire   [0:0] icmp_ln81_fu_346_p2;
reg    ap_block_state1;
...
wire   [31:0] data_V_fu_432_p1;
wire   [31:0] p_Result_s_fu_440_p3;
wire   [31:0] data_V_1_fu_452_p1;
wire   [24:0] mantissa_fu_470_p4;
wire   [8:0] zext_ln346_fu_483_p1;
wire   [8:0] add_ln346_fu_486_p2;
wire   [7:0] sub_ln1512_fu_500_p2;
wire   [0:0] isNeg_fu_492_p3;
wire  signed [8:0] sext_ln1512_fu_505_p1;
wire   [8:0] ush_fu_509_p3;
wire  signed [31:0] sext_ln1488_fu_517_p1;
wire   [54:0] zext_ln68_fu_479_p1;
wire   [54:0] zext_ln1488_fu_521_p1;
wire   [54:0] r_V_fu_525_p2;
wire   [0:0] tmp_fu_537_p3;
wire   [54:0] r_V_14_fu_531_p2;
wire   [7:0] zext_ln818_fu_545_p1;
wire   [7:0] tmp_29_fu_549_p4;
wire   [7:0] val_fu_559_p3;
...
#0 grp_generic_modf_float_s_fu_223_ap_start_reg = 1'b0;
#0 grp_generic_modf_float_s_fu_230_ap_start_reg = 1'b0;
...
top_module_generic_modf_float_s grp_generic_modf_float_s_fu_223(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
top_module_generic_modf_float_s grp_generic_modf_float_s_fu_230(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
top_module_fsub_32ns_32ns_32_4_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
top_module_fmul_32ns_32ns_32_3_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
top_module_sitofp_32ns_32_3_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
sitofp_32ns_32_3_no_dsp_1_U221(
    .clk(ap_clk),
    .reset(ap_rst),
...
top_module_fptrunc_64ns_32_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 32 ))
fptrunc_64ns_32_2_no_dsp_1_U222(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(reg_295),
    .ce(1'b1),
...
top_module_fpext_32ns_64_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
fpext_32ns_64_2_no_dsp_1_U223(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_264_p0),
    .ce(1'b1),
...
top_module_dsub_64ns_64ns_64_5_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dsub_64ns_64ns_64_5_full_dsp_1_U224(
    .clk(ap_clk),
    .reset(ap_rst),
...
top_module_dmul_64ns_64ns_64_5_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((regslice_both_output_stream_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln92_fu_391_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state28))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_generic_modf_float_s_fu_223_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state26) | (1'b1 == ap_CS_fsm_state49) | (1'b1 == ap_CS_fsm_state17))) begin
            grp_generic_modf_float_s_fu_223_ap_start_reg <= 1'b1;
        end else if ((grp_generic_modf_float_s_fu_223_ap_ready == 1'b1)) begin
            grp_generic_modf_float_s_fu_223_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_generic_modf_float_s_fu_230_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state49)) begin
            grp_generic_modf_float_s_fu_230_ap_start_reg <= 1'b1;
        end else if ((grp_generic_modf_float_s_fu_230_ap_ready == 1'b1)) begin
            grp_generic_modf_float_s_fu_230_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_NS_fsm_state29) & (1'b1 == ap_CS_fsm_state28)) | ((1'b1 == ap_NS_fsm_state6) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln81_fu_346_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        i_5_fu_158 <= 19'd0;
    end else if (((regslice_both_output_stream_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln92_fu_391_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state28))) begin
...
always @ (posedge ap_clk) begin
    if ((~((u_diff_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_138 <= 4'd0;
    end else if (((icmp_ln81_fu_346_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_generic_modf_float_s_fu_223_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_generic_modf_float_s_fu_223_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state27))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln92_fu_391_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state28))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state59)) begin
        ...
        xs_exp_V_reg_668 <= {{data_V_1_fu_452_p1[30:23]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state42) | (1'b1 == ap_CS_fsm_state38) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state6))) begin
        reg_277 <= grp_fu_264_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state57) | (1'b1 == ap_CS_fsm_state45) | (1'b1 == ap_CS_fsm_state40) | (1'b1 == ap_CS_fsm_state22) | (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state47) | (1'b1 == ap_CS_fsm_state15))) begin
        reg_295 <= grp_fu_273_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state49) | (1'b1 == ap_CS_fsm_state17))) begin
...
always @ (*) begin
    if ((grp_generic_modf_float_s_fu_223_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((grp_generic_remainder_float_s_fu_237_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((regslice_both_output_stream_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln92_fu_391_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state28))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state43) | (1'b1 == ap_CS_fsm_state20) | (1'b1 == ap_CS_fsm_state38) | (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state27)) begin
        ...
        grp_generic_modf_float_s_fu_223_x = 'bx;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state41) | (1'b1 == ap_CS_fsm_state39) | (1'b1 == ap_CS_fsm_state37) | (1'b1 == ap_CS_fsm_state36) | (1'b1 == ap_CS_fsm_state35) | (1'b1 == ap_CS_fsm_state34) | (1'b1 == ap_CS_fsm_state33) | (1'b1 == ap_CS_fsm_state32) | (1'b1 == ap_CS_fsm_state31) | (1'b1 == ap_CS_fsm_state30) | (1'b1 == ap_CS_fsm_state29) | (1'b1 == ap_CS_fsm_state16) | (1'b1 == ap_CS_fsm_state14) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state12) | (1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state17) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state40) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state42) | (1'b1 == ap_CS_fsm_state38) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state6) | ((grp_generic_modf_float_s_fu_223_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18)))) begin
...
always @ (*) begin
    if (((output_stream_TREADY_int_regslice == 1'b1) & (1'b1 == ap_CS_fsm_state60))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state18 : begin
            if (((grp_generic_modf_float_s_fu_223_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18))) begin
        ...
        ap_ST_fsm_state27 : begin
            if (((grp_generic_modf_float_s_fu_223_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state27))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state27;
            end
        ...
        ap_ST_fsm_state59 : begin
            if (((grp_generic_remainder_float_s_fu_237_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state59))) begin
        ...
        ap_ST_fsm_state61 : begin
            if (((output_stream_TREADY_int_regslice == 1'b1) & (1'b1 == ap_CS_fsm_state61))) begin
                ap_NS_fsm = ap_ST_fsm_state28;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state61;
            end
...
assign add_ln346_fu_486_p2 = ($signed(zext_ln346_fu_483_p1) + $signed(9'd385));
...
always @ (*) begin
    ap_block_state50_on_subcall_done = ((grp_generic_modf_float_s_fu_230_ap_done == 1'b0) | (grp_generic_modf_float_s_fu_223_ap_done == 1'b0));
end

assign data_V_1_fu_452_p1 = grp_generic_remainder_float_s_fu_237_ap_return;

assign data_V_fu_432_p1 = grp_fu_242_p2;

assign grp_generic_modf_float_s_fu_223_ap_start = grp_generic_modf_float_s_fu_223_ap_start_reg;

assign grp_generic_modf_float_s_fu_230_ap_start = grp_generic_modf_float_s_fu_230_ap_start_reg;
...
assign i_10_fu_397_p2 = (i_5_fu_158 + 19'd1);

assign i_8_fu_352_p2 = (i_fu_138 + 4'd1);

assign icmp_ln81_fu_346_p2 = ((i_fu_138 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln92_fu_391_p2 = ((i_5_fu_158 == 19'd262144) ? 1'b1 : 1'b0);

assign isNeg_fu_492_p3 = add_ln346_fu_486_p2[32'd8];

assign mantissa_fu_470_p4 = {{{{1'd1}, {p_Result_16_reg_674}}}, {1'd0}};

assign map_diff_fu_447_p1 = p_Result_s_fu_440_p3;

assign outHash_last_V_fu_403_p2 = ((i_5_fu_158 == 19'd262143) ? 1'b1 : 1'b0);

assign output_stream_TDATA_int_regslice = val_fu_559_p3;

assign output_stream_TVALID = regslice_both_output_stream_V_data_V_U_vld_out;

assign p_Result_16_fu_466_p1 = data_V_1_fu_452_p1[22:0];

assign p_Result_s_fu_440_p3 = {{1'd0}, {trunc_ln368_reg_658}};

assign r_V_14_fu_531_p2 = zext_ln68_fu_479_p1 << zext_ln1488_fu_521_p1;

assign r_V_fu_525_p2 = zext_ln68_fu_479_p1 >> zext_ln1488_fu_521_p1;

assign sext_ln1488_fu_517_p1 = $signed(ush_fu_509_p3);

assign sext_ln1512_fu_505_p1 = $signed(sub_ln1512_fu_500_p2);

assign sub_ln1512_fu_500_p2 = (8'd127 - xs_exp_V_reg_668);

assign tmp_29_fu_549_p4 = {{r_V_14_fu_531_p2[31:24]}};

assign tmp_fu_537_p3 = r_V_fu_525_p2[32'd24];

assign trunc_ln368_fu_436_p1 = data_V_fu_432_p1[30:0];

assign ush_fu_509_p3 = ((isNeg_fu_492_p3[0:0] == 1'b1) ? sext_ln1512_fu_505_p1 : add_ln346_fu_486_p2);

assign val_fu_559_p3 = ((isNeg_fu_492_p3[0:0] == 1'b1) ? zext_ln818_fu_545_p1 : tmp_29_fu_549_p4);

assign zext_ln1488_fu_521_p1 = $unsigned(sext_ln1488_fu_517_p1);

assign zext_ln346_fu_483_p1 = xs_exp_V_reg_668;

assign zext_ln68_fu_479_p1 = mantissa_fu_470_p4;

assign zext_ln818_fu_545_p1 = tmp_fu_537_p3;
