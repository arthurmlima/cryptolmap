...
output  [63:0] msg_strm5_din;
input  [15:0] msg_strm5_num_data_valid;
input  [15:0] msg_strm5_fifo_cap;
input   msg_strm5_full_n;
output   msg_strm5_write;
output  [63:0] len_strm6_din;
input  [1:0] len_strm6_num_data_valid;
input  [1:0] len_strm6_fifo_cap;
input   len_strm6_full_n;
output   len_strm6_write;
output  [0:0] end_len_strm7_din;
input  [1:0] end_len_strm7_num_data_valid;
input  [1:0] end_len_strm7_fifo_cap;
input   end_len_strm7_full_n;
output   end_len_strm7_write;
...
reg msg_strm5_write;
reg len_strm6_write;
reg[0:0] end_len_strm7_din;
reg end_len_strm7_write;
...
wire    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start;
wire    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_done;
wire    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_idle;
wire    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_ready;
wire   [63:0] grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_msg_strm5_din;
wire    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_msg_strm5_write;
wire    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_input_stream_TREADY;
reg    grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 5'd1;
#0 grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start_reg = 1'b0;
end

top_module_get_image_stream_Pipeline_VITIS_LOOP_17_1 grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((end_len_strm7_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start_reg <= 1'b1;
        end else if ((grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_ready == 1'b1)) begin
            grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((end_len_strm7_full_n == 1'b0) | (len_strm6_full_n == 1'b0))) begin
...
always @ (*) begin
    if ((end_len_strm7_full_n == 1'b0)) begin
...
always @ (*) begin
    if (((end_len_strm7_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((end_len_strm7_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        end_len_strm7_din = 1'd1;
    end else if ((~((end_len_strm7_full_n == 1'b0) | (len_strm6_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        end_len_strm7_din = 1'd0;
    end else begin
        end_len_strm7_din = 'bx;
    end
end

always @ (*) begin
    if ((((end_len_strm7_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state5)) | (~((end_len_strm7_full_n == 1'b0) | (len_strm6_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4)))) begin
        end_len_strm7_write = 1'b1;
    end else begin
        end_len_strm7_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((end_len_strm7_full_n == 1'b0) | (len_strm6_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        len_strm6_write = 1'b1;
    end else begin
        len_strm6_write = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    ap_block_state4 = ((end_len_strm7_full_n == 1'b0) | (len_strm6_full_n == 1'b0));
end

assign ap_ready = internal_ap_ready;

assign grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start = grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_ap_start_reg;

assign input_stream_TREADY = regslice_both_input_stream_V_data_V_U_ack_in;

assign len_strm6_din = 64'd262144;

assign msg_strm5_din = grp_get_image_stream_Pipeline_VITIS_LOOP_17_1_fu_71_msg_strm5_din;
