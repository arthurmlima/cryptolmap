...
entity top_module_fifo_w1_d32_D is
    generic (
...
architecture arch of top_module_fifo_w1_d32_D is

    -- component
    component top_module_fifo_w1_d32_D_ram is
    generic (
        MEM_STYLE  : string  := "distributed";
...
begin
----------------------- Instantiation -----------------------
    U_top_module_fifo_w1_d32_D_ram : top_module_fifo_w1_d32_D_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity top_module_fifo_w1_d32_D_ram is
    generic (
        MEM_STYLE   : string  := "distributed";
        DATA_WIDTH  : integer := 1;
        ADDR_WIDTH  : integer := 5;
...
architecture arch of top_module_fifo_w1_d32_D_ram is
