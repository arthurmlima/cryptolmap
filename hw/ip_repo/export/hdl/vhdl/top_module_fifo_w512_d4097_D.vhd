...
entity top_module_fifo_w512_d4097_D is
    generic (
...
architecture arch of top_module_fifo_w512_d4097_D is

    -- component
    component top_module_fifo_w512_d4097_D_ram is
    generic (
        MEM_STYLE  : string  := "distributed";
...
begin
----------------------- Instantiation -----------------------
    U_top_module_fifo_w512_d4097_D_ram : top_module_fifo_w512_d4097_D_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity top_module_fifo_w512_d4097_D_ram is
    generic (
        MEM_STYLE   : string  := "distributed";
        DATA_WIDTH  : integer := 512;
        ADDR_WIDTH  : integer := 13;
...
architecture arch of top_module_fifo_w512_d4097_D_ram is
