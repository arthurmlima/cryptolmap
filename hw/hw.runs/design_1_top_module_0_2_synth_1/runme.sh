...
HD_PWD='/home/arthur/gits/testecyrpto/hw/hw.runs/design_1_top_module_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_module_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_module_0_2.tcl
