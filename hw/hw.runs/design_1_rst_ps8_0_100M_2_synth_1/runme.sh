...
HD_PWD='/home/arthur/gits/testecyrpto/hw/hw.runs/design_1_rst_ps8_0_100M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_ps8_0_100M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_ps8_0_100M_2.tcl
