...
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_FULL_BLKS_fu_220_msg_strm5_read;
...
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_msg_strm5_read;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_15_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_15_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_14_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_14_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_13_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_13_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_12_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_12_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_11_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_11_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_10_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_10_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_9_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_9_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_8_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_8_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_7_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_7_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_6_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_6_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_5_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_5_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_4_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_4_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_3_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_3_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_2_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_2_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_1_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_1_out_ap_vld;
wire   [31:0] grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_out;
wire    grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_b_M_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln343_fu_315_p2 == 1'd0))) begin
        cmp116_reg_668 <= cmp116_fu_320_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((~((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1))) & (1'b1 == ap_CS_fsm_state9)) | (~((end_len_strm7_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (posedge ap_clk) begin
    if (((end_flag_3_reg_211 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        trunc_ln_reg_654 <= {{len_strm6_dout[63:6]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        trunc_ln1_reg_678 <= {{len_reg_634[5:3]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (cmp116_reg_668 == 1'd0))) begin
        tmp_1_reg_688 <= {{len_reg_634[60:29]}};
    end
end

always @ (*) begin
    if (((end_len_strm7_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0))) begin
...
always @ (*) begin
    if ((((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0)))) begin
...
always @ (*) begin
    if (((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1)))) begin
...
always @ (*) begin
    if ((~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1))) & (ap_predicate_op102_write_state9 == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (*) begin
    if (((~(((blk_strm_full_n == 1'b0) & (cmp116_reg_668 == 1'd0)) | ((blk_strm_full_n == 1'b0) & (cmp116_reg_668 == 1'd1))) & (1'b1 == ap_CS_fsm_state8) & (cmp116_reg_668 == 1'd0)) | (~(((blk_strm_full_n == 1'b0) & (cmp116_reg_668 == 1'd0)) | ((blk_strm_full_n == 1'b0) & (cmp116_reg_668 == 1'd1))) & (1'b1 == ap_CS_fsm_state8) & (cmp116_reg_668 == 1'd1)) | (~((blk_strm_full_n == 1'b0) & (icmp_ln343_fu_315_p2 == 1'd1)) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln343_fu_315_p2 == 1'd1)) | (~((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1))) & (ap_predicate_op102_write_state9 == 1'b1) & (1'b1 == ap_CS_fsm_state9)))) begin
        blk_strm_write = 1'b1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        blk_strm_write = grp_preProcessing_Pipeline_LOOP_SHA256_GEN_FULL_BLKS_fu_220_blk_strm_write;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | (~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1)))) begin
        ...
        end_len_strm7_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((~((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1))) & (1'b1 == ap_CS_fsm_state9)) | (~((end_len_strm7_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1)))) begin
        end_len_strm7_read = 1'b1;
    end else begin
...
always @ (*) begin
    if (((~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | (~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((end_flag_3_reg_211 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        len_strm6_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        len_strm6_read = 1'b1;
    end else begin
        len_strm6_read = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((end_len_strm7_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (end_flag_3_reg_211 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_preProcessing_Pipeline_LOOP_SHA256_GEN_FULL_BLKS_fu_220_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (grp_preProcessing_Pipeline_LOOP_SHA256_GEN_COPY_TAIL_PAD_ONE_fu_229_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state9 : begin
            if ((~((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1))) & (1'b1 == ap_CS_fsm_state9))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end
...
always @ (*) begin
    ap_block_state1 = ((end_len_strm7_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0));
end

always @ (*) begin
    ap_block_state2 = (((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state9 = ((end_len_strm7_empty_n == 1'b0) | ((blk_strm_full_n == 1'b0) & (ap_predicate_op102_write_state9 == 1'b1)));
end

always @ (*) begin
    ap_condition_355 = (~(((end_flag_3_reg_211 == 1'd0) & (end_nblk_strm11_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (nblk_strm8_full_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd0) & (len_strm6_empty_n == 1'b0)) | ((end_flag_3_reg_211 == 1'd1) & (end_nblk_strm11_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2));
end
...
assign left_fu_264_p1 = len_strm6_dout[5:0];

assign nblk_strm8_din = blk_num_fu_304_p2;
...
assign trunc_ln299_fu_286_p1 = len_strm6_dout[1:0];

assign trunc_ln485_fu_268_p1 = len_strm6_dout[28:0];

assign trunc_ln_fu_272_p4 = {{len_strm6_dout[63:6]}};
