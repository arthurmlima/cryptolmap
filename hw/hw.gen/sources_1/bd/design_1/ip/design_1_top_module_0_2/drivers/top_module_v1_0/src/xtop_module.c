...
void XTop_module_Set_u_perm(XTop_module *InstancePtr, u32 Data) {
    ...
    XTop_module_WriteReg(InstancePtr->Control_BaseAddress, XTOP_MODULE_CONTROL_ADDR_U_PERM_DATA, Data);
}
...
u32 XTop_module_Get_u_perm(XTop_module *InstancePtr) {
    ...
    Data = XTop_module_ReadReg(InstancePtr->Control_BaseAddress, XTOP_MODULE_CONTROL_ADDR_U_PERM_DATA);
    return Data;
}
